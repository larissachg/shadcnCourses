...
].sort((a, b) => a.name.localeCompare(b.name)); //Para que se ordene alfabeticamente
    ...
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900">
        ...
        >
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 dark:bg-slate-800">
